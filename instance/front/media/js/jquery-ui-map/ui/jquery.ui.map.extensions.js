...
( function($) {
	...
	$.extend($.ui.gmap.prototype, {
		...
		/**
		 * A Services to predict the desired Place based on user input. The Services is attached to an <input> field in the form of a drop-down list. The list of predictions is updated dynamically as text is typed into the input field.
