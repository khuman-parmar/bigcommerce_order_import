...
<div class="padding-md" style="margin-top:50px;">
			<div class="row">
				<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
					...
					<a class="btn btn-success m-bottom-sm" href="dashboard"><i class="fa fa-home"></i> Back to Dashboard</a>
					<a class="btn btn-success m-bottom-sm" href="contact"><i class="fa fa-envelope"></i> Contact Us</a>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.padding-md -->
